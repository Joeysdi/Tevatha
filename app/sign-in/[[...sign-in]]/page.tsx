      ...
      <div className="relative z-10 flex flex-col items-center gap-6">
        ...
        <div className="text-center mb-2">
          ...
          <h1 className="font-syne font-extrabold text-[26px] text-text-base leading-tight">
            Vault{" "}
            <span className="text-gold-protocol">Sign In</span>
          </h1>
          <p className="font-mono text-[10.5px] text-text-dim mt-2">
            Access your provisioner account
          </p>
        </div>
        ...
        <SignIn
          ...
          appearance={{
            elements: {
              ...
              identityPreviewText: "text-text-base font-mono text-[11px]",
              identityPreviewEditButton: "text-gold-protocol font-mono text-[11px]",
            },
          }}
        />
      </div>
